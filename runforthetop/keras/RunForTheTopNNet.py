...
class RunForTheTopNNet():
    def __init__(self, game, args):
        ...
        # Neural Net
        self.input_boards = Input(shape=(board_x, board_y))    # s: batch_size x board_x x board_y

        x_image = Reshape((board_x, board_y, 1))(self.input_boards)                # batch_size  x board_x x board_y x 1
        ...
        self.pi = Dense(action_size, activation='softmax', name='pi')(s_fc2)   # batch_size x action_size
